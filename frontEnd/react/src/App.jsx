...
// Importa os componentes de cada card
...
function App() {
  return (
    <div className="min-h-screen w-full bg-black text-gray-200 flex flex-col items-center p-4 sm:p-6 lg:p-8">
      
      <div className="w-full max-w-7xl mb-8 flex items-center space-x-4">
